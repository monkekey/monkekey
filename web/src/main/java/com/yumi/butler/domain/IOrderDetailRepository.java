...
public interface IOrderDetailRepository extends JpaRepository<OrderDetail, Long> {
    @Query("select new com.yumi.butler.vo.OrderDetailVo(od.orderNo, od.goodsId, g.goodsName, od.qty, od.salePrice) from OrderDetail od ,Goods g  where od.orderNo = :orderNo and od.goodsId = g.id")
